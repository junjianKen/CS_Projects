...
def foodHeuristic(state, problem):
    ...
    for i in food_Position:
        HeuristicDist.append(mazeDistance(position, i, problem.startingGameState))
    return max(HeuristicDist)
...
class AnyFoodSearchProblem(PositionSearchProblem):
    ...
    def isGoalState(self, state):
        ...
        "*** YOUR CODE HERE ***"
        # Check if the state is in foods' positions stored in Food.asList()
